...
def run(protocol):
    ...
    for i in range(12):
        ...
        p50Multi.aspirate(25, rnaCols[i].bottom(z=2))
        p50Multi.aspirate(25, rnaCols[i])
        p50Multi.dispense(50, outPlate.columns()[i][0])
        p50Multi.blow_out(outPlate.columns()[i][0])
        p50Multi.drop_tip()
